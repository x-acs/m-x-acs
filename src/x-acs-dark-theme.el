...
;; Version: 20231210
;; Keywords: themes, theme, x-acs, dark
...
(custom-theme-set-variables 'x-acs-dark
...
(let* ((class '((class color) (min-colors 89))) ; This variable is just to avoid every face customization
       ...
       (x-acs-red           "#C00")
       (x-acs-green         "#0A2")
       (x-acs-dark-yellow   "#C80")
       (x-acs-blue          "#03C")
       (x-acs-magenta       "#A0C")
       (x-acs-cyan          "#09B")
       (x-acs-light-gray    "#BBB")
       (x-acs-dark-gray     "#444")
       (x-acs-light-red     "#F22")
       (x-acs-light-green   "#0D5")
       (x-acs-yellow        "#FB1")
       (x-acs-light-blue    "#16F")
       (x-acs-light-magenta "#D3F")
       (x-acs-light-cyan    "#0CE")
       (x-acs-white         "#EEE")
